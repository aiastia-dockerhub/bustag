...
<div class="row">
	...
	<h6>
	% if curr_page != 1:
	<a href="?page=1{{like_param}}{{tag_param}}"> 第一页</a>
	% end
	% if curr_page > 1:
	<a href="?page={{curr_page - 1}}{{like_param}}{{tag_param}}"> 上一页</a>
	% end
	第{{curr_page}}页
	% if curr_page < max_page:
	 <a href="?page={{curr_page + 1}}{{like_param}}{{tag_param}}">下一页</a>
	% end
	% if curr_page != max_page:
	<a href="?page={{max_page}}{{like_param}}{{tag_param}}">最后页</a>
	% end
	</h6>
	<div>
	<form>
...
% url = '?page={}{}{}'.format(i, like_param, tag_param)
