    ...
    <div class="col-12">
      <form action="/search" method="get" class="form-inline justify-content-center">
        <div class="input-group" style="max-width: 400px;">
          <input type="text" name="q" class="form-control" placeholder="输入番号或关键词，如 SSIS-001 / 女教师" value="{{query}}">
...
% elif defined('query') and query != '':
  <div class="row py-3">
    <div class="col-12 text-center">
      <div class="alert alert-warning">未找到「{{query}}」的相关信息</div>
    </div>
  </div>
% end
...
% if query_items:
  <div class="row py-2">
    <div class="col-12">
      <h6>关键词「{{query}}」共找到 {{page_info[0]}} 条结果</h6>
    </div>
  </div>
  ...
  % end
  % include('pagination.tpl', page_info=page_info, q=query)
% end
